...
public class MusicLibraryGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addBTN.setBounds(680, 740, 120, 50);
        ...
        print_likedBTN.setBounds(400, 740, 150, 50);
        ...
        deleteBTN.setBounds(560, 740, 100, 50);
        ...
        moveBTN.setBounds(10, 740, 100, 50);
        likedsongsPANEL.add(titleTF);
        titleTF.setBounds(910, 570, 250, 40);
        ...
        searchBTN.setBounds(120, 740, 130, 50);
        ...
        sizeBTN.setBounds(260, 740, 130, 50);
        ...
        artistLBL.setBounds(840, 640, 60, 40);
        ...
        titleLBL.setBounds(840, 570, 60, 40);
        ...
        repeatTOGGLE2.setBounds(1040, 740, 120, 50);
        repeatTOGGLE2.setEnabled(false);
        likedsongsPANEL.add(artistTF);
        artistTF.setBounds(910, 640, 250, 40);
        ...
        NotesLBL1.setBounds(-190, 160, 990, 820);
        ...
        navTABS.addTab("LIKED SONGS", likedsongsPANEL);
        ...
        deleteBTN1.setBounds(460, 740, 100, 50);
        ...
        artistLBL1.setBounds(840, 640, 60, 40);
        ...
        print_hiphopBTN1.setBounds(290, 740, 160, 50);
        hiphopPANEL.add(artistTF1);
        artistTF1.setBounds(910, 640, 250, 40);
        ...
        sizeBTN1.setBounds(150, 740, 130, 50);
        hiphopPANEL.add(titleTF1);
        titleTF1.setBounds(910, 570, 250, 40);
        ...
        searchBTN1.setBounds(10, 740, 130, 50);
        ...
        titleLBL1.setBounds(840, 570, 60, 40);
        ...
        backgroundLBL1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/hiphop background imgs.jpg"))); // NOI18N
        ...
        navTABS.addTab("HIP-HOP", hiphopPANEL);
        ...
        print_pianoBTN2.setText("Print Piano");
        ...
        print_pianoBTN2.setBounds(290, 740, 130, 50);
        ...
        deleteBTN2.setBounds(430, 740, 100, 50);
        ...
        artistLBL2.setBounds(840, 640, 60, 40);
        painoPANEL.add(artistTF2);
        artistTF2.setBounds(910, 640, 250, 40);
        ...
        sizeBTN2.setBounds(150, 740, 130, 50);
        painoPANEL.add(titleTF2);
        titleTF2.setBounds(910, 570, 250, 40);
        ...
        searchBTN2.setBounds(10, 740, 130, 50);
        ...
        titleLBL2.setBounds(840, 570, 60, 40);
        ...
        backgroundLBL2.setBounds(0, 0, 1200, 870);
        ...
        navTABS.addTab("PIANO", painoPANEL);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(navTABS, javax.swing.GroupLayout.PREFERRED_SIZE, 832, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void repeatTOGGLE2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_repeatTOGGLE2ActionPerformed
        ...
        if (MusicLibraryGUI.repeatTOGGLE2.isSelected() == true) {
            ...
            GenrePlaylistImpl.getInstance().setRepeat(repeat);
    ...
    private void deleteBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTN1ActionPerformed
        ...
        if (titleTF1.getText().isEmpty() == true || artistTF1.getText().isEmpty() == true) {
            ...
            Song songToDelete = new Song(title, artist);
            GenrePlaylistImpl.getInstance().deleteHipHopSong(songToDelete);
        }
    }//GEN-LAST:event_deleteBTN1ActionPerformed

    private void sizeBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sizeBTN1ActionPerformed
        
        GenrePlaylistImpl.getInstance().countHiphopSongs();
    ...
    private void searchBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTN1ActionPerformed
        ...
        GenrePlaylistImpl.getInstance().searchHipHopSong(title, artist);
    ...
    private void deleteBTN2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTN2ActionPerformed
        ...
        if (titleTF2.getText().isEmpty() == true || artistTF2.getText().isEmpty() == true) {
            ...
            Song songToDelete = new Song(title, artist);
            GenrePlaylistImpl.getInstance().deletePianoSong(songToDelete);
        }
    ...
    private void sizeBTN2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sizeBTN2ActionPerformed
        ...
        GenrePlaylistImpl.getInstance().countPianoSongs();
    ...
    private void searchBTN2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTN2ActionPerformed
        ...
        GenrePlaylistImpl.getInstance().searchPianoSong(title, artist);
    ...
    private void print_hiphopBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_hiphopBTN1ActionPerformed
        ...
        GenrePlaylistImpl.getInstance().printHipHopPlaylist();
    ...
    private void print_pianoBTN2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print_pianoBTN2ActionPerformed
        ...
        GenrePlaylistImpl.getInstance().printPianoPlaylist();
